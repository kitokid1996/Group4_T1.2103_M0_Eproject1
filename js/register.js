        ...
        function    regex_birth()
{
    ...
    if(result==true)
    {
        ...
        document.getElementById("regex_birth").innerHTML = "<forn style='color: green;'>Bạn đã nhập dúng</forn>"
    }
    else
    {
        document.getElementById("image_birth").innerHTML = "<forn style='color: red;'>✖</forn>"
        document.getElementById("regex_birth").innerHTML = "<forn style='color: red;'>Bạn phải nhập năm/tháng/ngày </forn>"  
    }
    return false
}
// ----------------------------------------------------------------------------------------------------------------------
        function    regex_email()
{
    ...
    if(result==true)
    {
        ...
        document.getElementById("regex_mail").innerHTML = "<forn style='color: green;'>Bạn đã nhập dúng</forn>"
    }
    else
    {
        document.getElementById("image_mail").innerHTML = "<forn style='color: red;'>✖</forn>"
        document.getElementById("regex_mail").innerHTML = "<forn style='color: red;'>Bạn phải nhập năm/tháng/ngày </forn>"  
    }
    return false
}
// ----------------------------------------------------------------------------------------------------------------------
        function    regex_phone()
{
    ...
    if(result==true)
    {
        ...
        document.getElementById("regex_phone").innerHTML = "<forn style='color: green;'>Bạn đã nhập dúng</forn>"
    }
    else
    {
        document.getElementById("image_phone").innerHTML = "<forn style='color: red;'>✖</forn>"
        document.getElementById("regex_phone").innerHTML = "<forn style='color: red;'>Bạn phải nhập năm/tháng/ngày </forn>"  
    }
    return false
}
